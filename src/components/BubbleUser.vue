          ...
          <ul class="dropdown__menu-nav">
            <li class="dropdown__menu-item">
              ...
              >
                ...
                <div class="dropdown__menu-text">Mi cuenta</div>
              </a>
            </li>
            <li class="dropdown__menu-item">
              <a href="#" class="dropdown__menu-link" title="Desconectar">
                <div class="dropdown__menu-svg">
                ...
                <div @click="logout" class="dropdown__menu-text">
                  Desconectar
                </div>
              </a>
            </li>
...
.dropdown__menu {
  ...
  &-link {
    ...
    &:hover {
      color: rgb(51 89 99);
      background-color: rgba(51, 89, 99, 0.1);
    }
  }
  &-svg {
    width: 1.5rem;
