<template>
  ...
  <nav
    id="nav-normal"
    class="flex navbar navbar-fixed-position items-center justify-between lg:gap-x-20 gap-x-2 lg:px-5 px-3 order-1"
  >
    <div class="flex items-center flex-shrink-0 text-dark md:text-right">
      ...
      >
        <img
          ...
          alt="Logotipo de Avistaloo, si pulsa sobre él le llavará a la página de inicio"
        />
    ...
    <div class="text-sm justify-center hidden lg:flex">
      <router-link
        v-if="usuarioAutenticado"
        to="/"
        class="text-xl mt-1 lg:inline-block lg:mt-0 text-primary-color mr-4 transition duration-500 hover:scale-110"
      ...
      <a
        href="/wiki"
        class="text-xl mt-1 lg:inline-block text-center lg:mt-0 text-primary-color mr-4 transition duration-500 hover:scale-110"
        alt="Botón que lleva a la Wiki"
      >Wiki</a>
      <router-link
        v-if="usuarioAutenticado"
        to="/galeria"
        class="block text-xl my-4 lg:inline-block text-center mb-1 lg:mt-0 text-primary-color mr-4 transition duration-500 hover:scale-110"
        alt="Botón que lleva a la galería"
      >Galería</router-link>
      <router-link
        v-if="usuarioAutenticado"
        to="/mapa"
        class="block text-xl mt-1 lg:inline-block text-center lg:mt-0 text-primary-color transition duration-500 hover:scale-110"
        alt="Botón que lleva al mapa de avistamientos"
      >Mapa</router-link>
    </div>
    <div class="block lg:hidden">
      <button
        v-on:click="showMobileNavbar"
        id="nav-toggle"
        class="flex items-center px-3 py-2 border rounded text-primary-color border-primary-color hover:text-white hover:bg-primary-color appearance-none focus:outline-none"
        alt="Menú que muestra diferentes opciones de nacegación en pantallas pequeñas"
      >
  ...
  <nav
    tabindex="0"
    id="nav-mobile"
    class="navbar hidden flex-col items-center justify-between flex-wrap lg:hidden lg:gap-x-20 gap-x-2 lg:px-5 px-3 order-1"
    @blur="nofocus"
  >
        ...
        <ul class="flex">
          <li class="mb-2 mr-4">
            <router-link
              ...
              title="Mi cuenta"
              alt="Botón que lleva al perfil del usuario"
            >
          ...
          <li class="mb-2">
            ...
            >
              ...
              <div @click="logout">Desconectar</div>
            </a>
          </li>
        </ul>
      </div>
