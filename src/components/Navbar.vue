<template>
  ...
  <nav
    id="nav-normal"
    class="flex navbar items-center justify-between flex-wrap lg:gap-x-20 gap-x-2 lg:px-5 px-3 order-1"
  >
    <div class="flex items-center flex-shrink-0 text-dark md:text-right mr-6">
      <a
        v-if="!usuarioAutenticado"
        class="navbar-item transition duration-500 hover:scale-125"
        href="/"
      >
    ...
    >
      ...
      <div class="text-sm lg:flex-grow">
        ...
        <router-link
          v-if="usuarioAutenticado"
          to="/app/locations"
          class="block text-xl mt-1 lg:inline-block text-center lg:mt-0 text-primary-color mr-4 transition duration-500 hover:scale-110"
          >Mapa</router-link
        >
      </div>
  ...
  >
    ...
    <div
      id="nav-content"
      class="w-full items-center justify-center lg:w-auto pt-6 md:text-center"
    >
